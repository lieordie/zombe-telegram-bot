...
async def help_command(message: Message):
    ...
    help_text = """
🛠 <b>ДОСТУПНЫЕ КОМАНДЫ ZOBME TEAM:</b>
...
Готовьтесь, Dota-мир! ZOBME едет на TI! 💪
...
async def content_command(message: Message):
    ...
    content_text = """
🎬 <b>КОНТЕНТ ZOBME TEAM - СМЕХ И АДРЕНАЛИН! 🚀</b>
...
async def stats_command(message: Message):
    ...
    stats_text = """
📊 <b>СТАТИСТИКА ZOBME TEAM - ЦИФРЫ НЕ ВРУТ! 📈</b>
...
async def streams_command(message: Message):
    ...
    streams_text = """
🔴 <b>БЛИЖАЙШИЕ СТРИМЫ ZOBME TEAM</b>
...
async def main():
    logger.info("🚀 Бот ZOBME Team запущен с командами и кнопками!")
